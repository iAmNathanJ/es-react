import {c as createCommonjsModule,u as unwrapExports}from'./_commonjsHelpers-62a4d7f9.js';import {r as require$$1}from'./checkPropTypes-0f5ecd47.js';import'./react.development-1b0246f4.js';import {r as require$$0}from'./index-7f2f3a77.js';var scheduler_development = createCommonjsModule(function (module, exports) {
...
unwrapExports(scheduler_development);var scheduler = createCommonjsModule(function (module) {
...
unwrapExports(schedulerTracing_development);var tracing = createCommonjsModule(function (module) {

{
  module.exports = schedulerTracing_development;
}
});var reactDom_development = createCommonjsModule(function (module) {
{(function(){var React=require$$0;var _assign=Object.assign;var Scheduler=scheduler;var checkPropTypes=require$$1;var tracing$1=tracing;// Do not require this module directly! Use normal `invariant` calls with
 ...
 * @param {DOMElement} node
 * @param {object} styles
 */function setValueForStyles(node,styles){var style=node.style;for(var styleName in styles){if(!styles.hasOwnProperty(styleName)){continue;}var isCustomProperty=styleName.indexOf('--')===0;{if(!isCustomProperty){warnValidStyle$1(styleName,styles[styleName]);}}var styleValue=dangerousStyleValue(styleName,styles[styleName],isCustomProperty);if(styleName==='float'){styleName='cssFloat';}if(isCustomProperty){style.setProperty(styleName,styleValue);}else{style[styleName]=styleValue;}}}// those special-case tags.
...
} = reactDom_development;export default reactDom_development;export{__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,createPortal,findDOMNode,flushSync,hydrate,render,unmountComponentAtNode,unstable_batchedUpdates,unstable_createPortal,unstable_renderSubtreeIntoContainer};